...
#SBATCH --output=/project/jesu4262/1_linux/rnaseq/new_output/%j_%x_myoutputfile.out
#SBATCH --error=/project/jesu4262/1_linux/rnaseq/new_output/%j_%x_myerrorfile.err
...
fastqc  --nogroup --threads 2 --extract -o /project/jesu4262/1_linux/rnaseq/new_output \
/project/jesu4262/1_linux/rnaseq/fastq/ERR1755082_*.fastq.gz
